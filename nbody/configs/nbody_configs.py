...
def train_arg_parser():
    ...
    parser.add_argument('--data_path', type=str, default='train_data.npy', help='Path to the dataset')
    parser.add_argument('--val_data_path', type=str, default='val_data.npy', help='Path to the dataset')
    ...
    parser.add_argument('--model_name',type=str,default="nff",help='which model to use')
    parser.add_argument('--vis_interval', type=int, default=100, help='Visualization interval')
    parser.add_argument('--seed', type=int, default=0, help='Random seed')
    parser.add_argument('--sample_num', type=int, default=200, help='Number of samples to train')
    parser.add_argument('--history_len', type=int, default=1, help='history length of slotformer / interaction network')
    parser.add_argument('--num_slots', type=int, default=10, help='Number of slots in SlotFormer')
    ...
    parser.add_argument('--noise_level', type=float, default=0, help='Noise level for NBodyDataset')
